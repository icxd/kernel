...
#define EH_ENTRY_FN(n) EH_ENTRY(n) void exception_##n##_handler(RegisterDumpWithExceptionCode &regs)
#define EH_ENTRY_NO_CODE_FN(n) EH_ENTRY_NO_CODE(n) void exception_##n##_handler(RegisterDump &regs)
...
#define EH(n, msg) static void _exception##n() { \
  kprintf(msg"\n");                              \
  u32 cr0, cr2, cr3, cr4;                        \
