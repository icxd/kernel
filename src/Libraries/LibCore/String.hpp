...
namespace Core {
  ...
  public:
    explicit String(const char *string)
        : m_string(string), m_size(strlen(string)) {}
  ...
  public:
    ...
    StringBuilder &append(int value, FormatterIntegerRepresentation type =
                                         FormatterIntegerRepresentation::None);
    StringBuilder &append(i64 value, FormatterIntegerRepresentation type =
                                         FormatterIntegerRepresentation::None);
    ...
    //     FormatterIntegerRepresentation::None
    // );
    StringBuilder &append(u32 value, FormatterIntegerRepresentation type =
                                         FormatterIntegerRepresentation::None);
    StringBuilder &append(u64 value, FormatterIntegerRepresentation type =
                                         FormatterIntegerRepresentation::None);
    // StringBuilder &append(
    //     usz value,
    //     FormatterIntegerRepresentation type =
