...
namespace Core {
  ...
  template <>
  struct IsInteger<bool> : TrueType {};
  template <>
  struct IsInteger<char> : TrueType {};
  template <>
  struct IsInteger<signed char> : TrueType {};
  template <>
  struct IsInteger<unsigned char> : TrueType {};
  template <>
  struct IsInteger<wchar_t> : TrueType {};
  template <>
  struct IsInteger<char16_t> : TrueType {};
  template <>
  struct IsInteger<char32_t> : TrueType {};
  template <>
  struct IsInteger<short> : TrueType {};
  template <>
  struct IsInteger<unsigned short> : TrueType {};
  template <>
  ...
  template <>
  struct IsInteger<unsigned long> : TrueType {};
  template <>
  struct IsInteger<long long> : TrueType {};
  template <>
  struct IsInteger<unsigned long long> : TrueType {};
  template <typename T>
  ...
  template <class T>
  struct RemoveConstReference_I {
    using type = T;
  };
  template <class T>
  struct RemoveConstReference_I<T &> {
    using type = T;
  };
  template <class T>
  struct RemoveConstReference_I<T &&> {
  ...
  template <class T>
  struct RemoveConstReference_I<const T &> {
    using type = T;
  };
  template <class T>
  using RemoveConstReference = typename RemoveConstReference_I<T>::type;
  ...
  template <class T>
  struct RemoveVolatile_I {
    using type = T;
  };
  template <class T>
  struct RemoveVolatile_I<volatile T> {
    using type = T;
  };
  template <class T>
  using RemoveVolatile = typename RemoveVolatile_I<T>::type;
  ...
  template <class T>
  struct RemoveCV_I<const T> {
    using type = T;
  };
  template <class T>
  struct RemoveCV_I<volatile T> {
    using type = T;
  };
  template <class T>
  struct RemoveCV_I<const volatile T> {
    using type = T;
  };
  template <class T>
  using RemoveCV = typename RemoveCV_I<T>::type;

  template <typename, typename>
  struct IsSame_I : FalseType {};
  template <typename A>
  struct IsSame_I<A, A> : TrueType {};
  ...
  template <class T>
  struct IsVoid : IsSame_I<void, RemoveCV<T>> {};

  template <class From, class To>
  struct IsConvertible;
  template <class From>
  struct IsConvertible<From, void> : TrueType {};
  template <class From, class To>
  ...
  struct IsConvertible
      : IntegralConstant<bool,
                         (decltype(Detail::TestReturnable<To>(0))::value &&
                          decltype(Detail::TestImplicitlyConvertible<From, To>(
                              0))::value) ||
