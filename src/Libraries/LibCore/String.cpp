...
namespace Core {
  ...
  StringBuilder &
  StringBuilder::append(const i64 value,
                        const FormatterIntegerRepresentation type) {
    int radix = 10;
    switch (type) {
    case FormatterIntegerRepresentation::Binary:
  ...
  // StringBuilder &StringBuilder::append(const isz value, const
  ...
  //   case FormatterIntegerRepresentation::Character:
  //   append(static_cast<char>(value)); return *this; case
  //   FormatterIntegerRepresentation::None: break;
  //   }
  ...
  StringBuilder &
  StringBuilder::append(const u32 value,
                        const FormatterIntegerRepresentation type) {
    int radix = 10;
    switch (type) {
    case FormatterIntegerRepresentation::Binary:
  ...
  StringBuilder &
  StringBuilder::append(const u64 value,
                        const FormatterIntegerRepresentation type) {
    int radix = 10;
    switch (type) {
    case FormatterIntegerRepresentation::Binary:
  ...
  // StringBuilder &StringBuilder::append(usz value,
  // FormatterIntegerRepresentation type) {
  //   int radix = 10;
  //   switch (type) {
  //   case FormatterIntegerRepresentation::Binary: radix = 2; break;
